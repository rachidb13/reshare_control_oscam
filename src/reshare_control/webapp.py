...
def _page(title, body):
    ...
    *{box-sizing:border-box}body{font-family:system-ui,-apple-system,Segoe UI,sans-serif;margin:0;background:var(--bg);color:var(--text);font-size:15px;line-height:1.45}
    ...
    .table-wrap{width:100%%;overflow:auto;border:1px solid var(--line);border-radius:8px}table{width:100%%;border-collapse:collapse;background:#fff;min-width:920px}th,td{text-align:left;padding:11px 12px;border-bottom:1px solid #e8edf3;vertical-align:middle}th{background:#f8fafc;color:#475569;font-size:12px;text-transform:uppercase;letter-spacing:0;font-weight:800}tr:last-child td{border-bottom:0}.primary-cell{font-weight:750;white-space:nowrap}.primary-cell span{display:block;color:var(--muted);font-size:13px;font-weight:600;margin-top:2px}
    ...
    .policy{display:grid;grid-template-columns:105px 92px 128px auto;gap:8px;align-items:end;min-width:440px}.policy input{width:100%%}.policy select{width:100%%;font:inherit;padding:9px 10px;border:1px solid #aab4c2;border-radius:7px;background:#fff}
    ...
    button,.button{font:inherit;font-weight:800;padding:9px 12px;border:1px solid #aab4c2;border-radius:7px;background:#fff;color:#17202a;cursor:pointer;display:inline-block;line-height:1.2;white-space:nowrap}.primary,.button.primary{background:var(--brand);border-color:var(--brand);color:#fff}.button.active{background:#17202a;color:#fff;border-color:#17202a}.danger{border-color:#f2b8b5;color:var(--bad);background:#fff7f7}.filters,.search{display:flex;gap:8px;margin:0 0 12px;flex-wrap:wrap}.search input{max-width:320px}
    ...
    @media (max-width:900px){.hero,.toolbar{align-items:flex-start;flex-direction:column}.metrics{grid-template-columns:repeat(2,minmax(0,1fr))}.grid{grid-template-columns:1fr}.span-2,.switches{grid-column:1}.policy{grid-template-columns:1fr 1fr}.form-actions{justify-content:stretch}.form-actions button{width:100%%}}
